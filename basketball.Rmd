...
our correlation tests multiple ways in order to ensure their success. In our 
first correlation test, the QQ plots showed some non-normality. We could have 
come up with more accurate conclusions if the condition of normality was met. In 
addition, we performed a T-test on the full population. Due to the fact that NBA 
changes every year, performing a T-test on the full population might suggest 
accurate predictions about future years. In terms of our data, most of the 
variables are numeric, and do not necessarily contain all of the nuances of the 
NBA, such as coaching, team morale, synergy between teammates, and injuries.
