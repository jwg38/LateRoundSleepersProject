...
#all NBA
all_nba <- nba_players %>% 
  filter(player_name == "Giannis Antetokounpo" |
         player_name == "LeBron James" |
         player_name == "James Harden" |
         player_name == "Anthony Davis" |
         player_name == "Luka Doncic" |
         player_name == "Kawahi Leonard" |
         player_name == "Nikola Jokic" |
         player_name == "Damien Lillard" |
...
data_for_ex_2 <- nba_players %>%
  select(team, raptor_total, team_win_pc) 
...
total_data_ex_2 %>%
  summarise(cor_team_win_team_raptor = cor(team_win_pc, 
                                           team_average_total_raptor))

ggplot(data = total_data_ex_2, aes(x = team_average_total_raptor, 
                                   y = team_win_pc)) +
  geom_point()
