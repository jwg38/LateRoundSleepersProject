...
ggplot(data = all_nba, aes(x=factor(1), fill=player_type))+
  ...
  coord_polar("y") +
  labs(title = 
         "Two-Way players have the highest representation on the All-NBA teams",
       fill = "Player Type")+
...
ggplot(data = nba_players, aes(x=factor(1), fill=player_type))+
  ...
  coord_polar("y") +
  labs(title = 
         "Defensive and No-way Players make up the majority of the NBA",
       fill = "Player Type")+
  theme(axis.title.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.title.y=element_blank(),
...
ggplot(data=player_type_data) +
  geom_col(aes(player_type, raptor_total, fill = player_type), 
             stat = "identity") +
...
ggplot(data=player_type_data) +
  geom_col(aes(player_type, war_total, fill = player_type), 
             stat = "identity") +
